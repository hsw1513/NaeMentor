...
@Controller
public class AjaxNotification_CTRL {
	...
	@ResponseBody
	public String page(HttpSession session, RowNumUtil rUtil) {
		log.info("notiquestion page, {}", rUtil);
		NaememberDto mDto = (NaememberDto)session.getAttribute("auth");
		
		JSONObject json = null;
		
		rUtil.setTotal(service.notiBoardListTotal());
		json = makeJson(service.notiAll(rUtil), rUtil);
